...
int main() {
    ...
    sprintf(manPage, ".\\\" Copyright Lluís Batlle i Rossell\n"
                     ...
                     ".TP\n"
                     ".B \"\\-q [queue]\"\n"
                     "Specify the queue, shortcut for specifying TS_SOCKET. A path will create "
                     "(or use) a socket at the given path. A name (without preceding in '.' or '/')"
                     "will create the named socket in the global tmp directory.\n"
                     ".TP\n"
                     ".B \"\\-Q/--last_queue_id\"\n"
